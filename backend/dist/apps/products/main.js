...
], ProductsController.prototype, "getHello", null);
...
exports.ProductsModule = ProductsModule = __decorate([
    (0, common_2.Module)({
        imports: [common_1.DatabaseModule, common_1.DatabaseModule.forFeature([common_1.Product])],
...
let ProductsRepository = ProductsRepository_1 = class ProductsRepository extends common_1.AbstractRepository {
    constructor(productsRepository, entityManager) {
        super(productsRepository, entityManager);
        this.logger = new common_2.Logger(ProductsRepository_1.name);
    }
};
exports.ProductsRepository = ProductsRepository;
exports.ProductsRepository = ProductsRepository = ProductsRepository_1 = __decorate([
    (0, common_2.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(common_1.Product)),
...
exports.ProductsService = ProductsService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof products_repository_1.ProductsRepository !== "undefined" && products_repository_1.ProductsRepository) === "function" ? _a : Object])
], ProductsService);
...
/***/ "./libs/common/src/dto/create-product.dto.ts":
/*!***************************************************!*\
  !*** ./libs/common/src/dto/create-product.dto.ts ***!
  \***************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./create-product.dto */ "./libs/common/src/dto/create-product.dto.ts"), exports);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
__exportStar(__webpack_require__(/*! ./product.entity */ "./libs/common/src/models/product.entity.ts"), exports);


/***/ }),

/***/ "./libs/common/src/models/product.entity.ts":
/*!**************************************************!*\
  !*** ./libs/common/src/models/product.entity.ts ***!
  \**************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @app/common */ "./libs/common/src/index.ts");
const typeorm_1 = __webpack_require__(/*! typeorm */ "typeorm");
let Product = class Product extends common_1.AbstractEntity {
};
...
], Product.prototype, "displayStatus", void 0);
